# WhisperVault —  Secret Sharing

WhisperVault is a small **Express + MongoDB** app that lets users register, log in (**Local + Google OAuth**), submit **secrets**, and recover accounts using **OTP-based email verification**. Passwords are securely stored using **bcrypt hashing**, and all views use a simple **EJS UI**.
